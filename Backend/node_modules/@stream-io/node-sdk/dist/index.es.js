    ...
    constructor(apiConfig) {
        ...
        this.sendRequest = (method, url, pathParams, queryParams, body) => __awaiter(this, void 0, void 0, function* () {
            ...
            const headers = {
                ...
                'X-Stream-Client': 'stream-node-' + "0.4.0",
...
class VideoApi extends BaseApi {
    constructor() {
        ...
        this.startRTMPBroadcast = (request) => __awaiter(this, void 0, void 0, function* () {
            var _r;
            const pathParams = {
                type: request === null || request === void 0 ? void 0 : request.type,
                id: request === null || request === void 0 ? void 0 : request.id,
...
class CallApi {
    constructor(videoApi, type, id) {
        ...
        this.startRTMPBroadcast = (request) => {
            return this.videoApi.startRTMPBroadcast(Object.assign({ id: this.id, type: this.type }, request));
        };
